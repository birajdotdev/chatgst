...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-B6SFevFz.js");
...
const manifest = { "586106710aa4ebaa280b7148db77ad9947aa1a2200401cb96c271426bf992248": {
  functionName: "getAuthData_createServerFn_handler",
  importer: () => import("./assets/_protected-BXYWUuL4.js")
}, "c91aa17c75770a201a72b152bfcd8a8b52640e16c31bb2a2687d77cdb45508a0": {
  functionName: "getUserProfile_createServerFn_handler",
  importer: () => import("./assets/profile-CTbc68dd.js")
}, "3d82bde82f26c89034216a22956c8746729c62e208bb72d3bdae08c5d406ef7c": {
  functionName: "getSessionFn_createServerFn_handler",
  importer: () => import("./assets/session.server-CuftA5LC.js")
}, "e30d56bee5d09b16918aa78f8d5a871d9305251df85e233e52d32e06dce1f317": {
  functionName: "createSessionFn_createServerFn_handler",
  importer: () => import("./assets/session.server-CuftA5LC.js")
}, "ba7b06fe48b1583455a04f827c1f1899ac9b667c5295b2a7ab4e4f8bb2b0de95": {
  functionName: "updateAccessTokenFn_createServerFn_handler",
  importer: () => import("./assets/session.server-CuftA5LC.js")
}, "dafcf6a7374d783f34818d1e228e3c725608f417952133c82e677c305f3ebdb7": {
  functionName: "deleteSessionFn_createServerFn_handler",
  importer: () => import("./assets/session.server-CuftA5LC.js")
}, "715af993a56fb9ddf0148aadc6f24492f6de40edfcafb54f9841669a6020ee07": {
  functionName: "verifySessionFn_createServerFn_handler",
  importer: () => import("./assets/session.server-CuftA5LC.js")
}, "7410d524e125003a516ec84ca8008c0bff6d7ad56963d5d8aea7d2f89819bd7c": {
  functionName: "extractEntitiesFn_createServerFn_handler",
  importer: () => import("./assets/extract-entities-action-Cy5pdzRE.js")
}, "06fd1849caa911a803219791b0037b1774667c374965f82387156fcb78ab7ad3": {
  functionName: "sendOtpFn_createServerFn_handler",
  importer: () => import("./assets/otp-action-Z3L5t-ia.js")
}, "ee32b3f2b0fdc7bab9d2d789e2032b225aa5915f25bc8b30350a64a204881ad6": {
  functionName: "verifyOtpFn_createServerFn_handler",
  importer: () => import("./assets/otp-action-Z3L5t-ia.js")
}, "93ae0e98c8004f73756f815967f3548ecb2d343b5c510adae0c0046c7503fc9f": {
  functionName: "signupFn_createServerFn_handler",
  importer: () => import("./assets/signup-action-B0jxnEw-.js")
}, "ec1437b8ae4bfbced3278d2ef71546d53d8230a2916e166670e54dc943097e1a": {
  functionName: "updateProfileFn_createServerFn_handler",
  importer: () => import("./assets/update-profile-action-BOSBqIny.js")
}, "114fbb07700c233a6bedf29f9acc2b40fcae0d7b5e8f6728b100c120d5b69c03": {
  functionName: "attachSupportingDocumentsFn_createServerFn_handler",
  importer: () => import("./assets/attach-supporting-documents-action-ElLvVG6F.js")
}, "9ccda1449568e561784d1e6387114bad2178ffbcd298a655c2df67808f088fbb": {
  functionName: "forgotPasswordFn_createServerFn_handler",
  importer: () => import("./assets/forgot-password-action-ULRUiGBy.js").then((n2) => n2.f)
}, "9a5bb0bc178e3b2603b2a67e4eb9ad71dd0cdd4b3265e19358e9a672eec2a1d5": {
  functionName: "verifyResetOtpFn_createServerFn_handler",
  importer: () => import("./assets/forgot-password-action-ULRUiGBy.js").then((n2) => n2.f)
}, "58bfcf80d1477dff57a2620fbe8bf32201968f46db3faa185855e0e0e4b37d97": {
  functionName: "resetPasswordFn_createServerFn_handler",
  importer: () => import("./assets/forgot-password-action-ULRUiGBy.js").then((n2) => n2.f)
}, "568be227f0e1df929cdf5506140e923491e236b0d10fcaba82ec1cb940943cc8": {
  functionName: "updateDocumentFn_createServerFn_handler",
  importer: () => import("./assets/update-document-action-DHg3fiEk.js")
}, "663e1af1141f112ce528bb454e44cbf262050cba8608dc5d84f97dcee10319e9": {
  functionName: "getProfileFn_createServerFn_handler",
  importer: () => import("./assets/get-profile-action-CSY2bSZo.js")
}, "8049cc69294c272842b7e79f43fd004930122117ae4cae183aa78ee4017cf142": {
  functionName: "logoutFn_createServerFn_handler",
  importer: () => import("./assets/logout-action-BmJvY5fl.js")
}, "8cf5829d2f77c547d6ed7823d30b8439f3d34fd4b385b82189e3525c1feb5fdd": {
  functionName: "updateAppealFn_createServerFn_handler",
  importer: () => import("./assets/update-appeal-action-DIrxPRu7.js")
}, "acb412f615e5d4850877d8658d06340c5093eec8fe1dc087911f3ea89b53c47e": {
  functionName: "resetProfilePasswordFn_createServerFn_handler",
  importer: () => import("./assets/reset-password-action-DCfy3R2V.js")
}, "f4c7caca3dce3bbf3bc8924b59451f1ed9cbba6281b1c9e968140cd59a449b8b": {
  functionName: "toggleIssueSelectionFn_createServerFn_handler",
  importer: () => import("./assets/toggle-issue-selection-action-VPmP8vng.js")
}, "4c9debdffd5b89046eb07123f6f129c883d26ecf2f72bec28fe3efe6dbb9fa5c": {
  functionName: "toggleLegalReferenceSelectionFn_createServerFn_handler",
  importer: () => import("./assets/toggle-legal-reference-selection-action-BVH0RC_4.js")
}, "1d6d5f189feb09a3a2f96f6d5f4892c50d12c22b3b88cafc645f6adda06244d0": {
  functionName: "deleteAppealFn_createServerFn_handler",
  importer: () => import("./assets/delete-appeal-DoSEz40S.js")
} };
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-CXy64lwh.js").then((n2) => n2.r);
